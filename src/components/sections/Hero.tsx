  ...
  return (
    <section id="topo" className="relative isolate min-h-[640px] overflow-hidden sm:min-h-[760px]">
      ...
      <div className="relative z-0 mx-auto flex max-w-7xl flex-col items-start gap-8 px-6 py-20">
        <div>
          <p className="mb-4 font-mono text-xl uppercase tracking-widest text-accent">200 OK</p>
          <h1 className="font-display text-4xl font-bold leading-tight sm:text-5xl">
            Foco em arquitetar o back-end para sustentar sistemas críticos e de alta
            disponibilidade.
          </h1>
          <p className="mt-4 text-justify text-muted">
