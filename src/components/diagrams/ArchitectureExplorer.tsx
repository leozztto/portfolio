...
export function ArchitectureExplorer() {
  ...
  return (
    <div className="rounded-xl border border-border bg-gradient-to-br from-surface/80 to-surface/35 p-6 shadow-lg shadow-black/20 transition !duration-200 hover:border-accent/50">
